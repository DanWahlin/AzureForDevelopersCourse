...
namespace AzureForDevelopersCourse.Repository.Functions
{
    public static class Unzipper
    {
        [FunctionName("Unzipper")]
        public static async Task Run([BlobTrigger("zipped-files/{name}", Connection = "unzipperFuncsStorage")]CloudBlockBlob blob, string name, ILogger log)
        {
